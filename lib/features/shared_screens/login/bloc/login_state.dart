...
class LoginErrorState extends LoginState {
  ...
  const LoginErrorState({required this.errorMessage, required this.codeError});
}
...
class UserInfoSavedState extends LoginState{}
class NavToHomeScreenState extends LoginState{
  final String type;
  final int id;

 const NavToHomeScreenState({required this.type, required this.id});
}
